...
<div class="wrap">
  <div class="card-main">
    ...
    <div class="card-body-inner">
      ...
      <div class="alert-custom alert-warn">
        ...
        <span>Lisensi saat ini masih aktif hingga <strong><?= date('d F Y', strtotime($status['expired_date'])) ?></strong>. Masukkan key baru untuk menggantinya. &nbsp;<a href="<?= BASE_URL ?>/login.php" style="color:#854d0e;font-weight:700">← Kembali ke Login</a></span>
      </div>
      <?php endif; ?>
      ...
      <div class="alert-custom alert-success">
        ...
        <span><?= $success ?> <a href="<?= BASE_URL ?>/login.php" style="color:#166534;font-weight:700">→ Login sekarang</a></span>
      </div>
      <?php endif; ?>
      ...
      <div class="contact-box">
        <strong>Hubungi Pengembang</strong>
  ...
  <div class="footer-txt">
    <?= e($namaAplikasi) ?> &copy; <?= date('Y') ?> · Dikembangkan oleh Cahyana Wijaya
  </div>
</div>
