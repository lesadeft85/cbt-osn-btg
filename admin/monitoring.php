...
$sedang = $conn->query("
    SELECT u.id, u.waktu_mulai,
           $pelanggarCol
           $lastActCol
           p.nama, p.kode_peserta, p.kode_sekolah, p.kelas, s.nama_sekolah,
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0" id="tblSedang">
                <thead><tr>
                    <th>#</th><th>Nama</th><th>Kode</th><th> Sekolah</th><th>Ruang</th><th>Tes</th>
                ...
                <tr class="<?= $rowClass ?>">
                    ...
                    <td><code><?=htmlspecialchars($r['kode_sekolah']??'-')?></code></td>
