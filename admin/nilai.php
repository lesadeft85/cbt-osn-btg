...
// FIX: support rombel — "IV" cocok dengan "IV", "IV A", "IV B", dst
if ($filterKelas) {
    $fk = $conn->real_escape_string($filterKelas);
    $where .= " AND (p.kelas = '$fk' OR p.kelas LIKE '$fk %')";
}
                    ...
                    <table class="table table-hover datatable mb-0" id="tabelNilai">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><code><?= htmlspecialchars($h['kode_sekolah'] ?? '-') ?></code></td>
                    ...
                    <table class="table table-hover datatable mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="small"><code><?= htmlspecialchars($p['kode_sekolah'] ?? '-') ?></code></td>
