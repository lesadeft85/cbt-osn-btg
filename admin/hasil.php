                    ...
                    <table class="table table-hover mb-0" id="tabelHasil">
                        ...
                        <tr>
                            <td class="text-center fw-800">
                                <?= (int)$rank===1?'<span style="font-size:20px">🥇</span>':((int)$rank===2?'<span style="font-size:20px">🥈</span>':((int)$rank===3?'<span style="font-size:20px">🥉</span>':"<span class='text-muted'>$rank</span>")) ?>
                            </td>
                            <td>
                            ...
                            <td><code class="text-muted"><?= e($h['kode_sekolah'] ?? '-') ?></code></td>
                    ...
                    <table class="table table-hover mb-0 datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="small"><code><?= e($p['kode_sekolah'] ?? '-') ?></code></td>
