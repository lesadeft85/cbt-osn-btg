...
<div class="page-header">
    <div>
        <h2><i class="bi bi-building me-2 text-primary"></i>Kelola Tes</h2>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <span><i class="bi bi-list-ul me-2"></i>Daftar Tes</span>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table id="tblSekolah" class="table table-hover datatable mb-0">
                <thead><tr>
                    <th>#</th><th>Nama Tes</th><th>Jenjang</th><th>NPSN</th><th>Alamat</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        switch ($row['jenjang']??'SD') {
                            case 'MTS':
                                $jBadge = 'bg-success'; break;
                            case 'MA':
                                $jBadge = 'bg-warning text-dark'; break;
                            case 'SMK':
                                $jBadge = 'bg-danger'; break;
                            default:
                                $jBadge = 'bg-primary'; break;
                        }
                        ?>
                ...
                <tr><td colspan="8" class="text-center text-muted py-5">
                    <i class="bi bi-inbox fs-2 d-block mb-2"></i>Belum ada data Tes
                </td></tr>
                <?php endif; ?>
                </tbody>
            </table>
...
<?= csrfField() ?>
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="bi bi-building me-2"></i>Tambah Tes Baru</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-md-8">
                        <label class="form-label fw-semibold">Nama Tes <span class="text-danger">*</span></label>
                        <input type="text" name="nama_sekolah" class="form-control" required
                               value="<?= htmlspecialchars($_POST['nama_sekolah']??'') ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Kode Tes</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Simpan Tes</button>
            </div>
        </form>
    </div>
</div>
...
<?= csrfField() ?>
            ...
            <div class="modal-header bg-warning">
                <h5 class="modal-title"><i class="bi bi-pencil me-2"></i>Edit Tes</h5>
