...
<table>
    ...
    <tbody>
    <?php if (!$absensiRows): ?>
    <tr><td colspan="11" style="text-align:center;padding:16px;color:#94a3b8">Belum ada data</td></tr>
    <?php else: $no=1; foreach($absensiRows as $r):
                // PHP 7.4 compat: match() → switch
        switch ($r['status_ujian']) {
            case 'Selesai':
                $sc = 's-selesai'; break;
            case 'Sedang':
                $sc = 's-sedang'; break;
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:9px"><code><?= e($p['kode_sekolah'] ?? '-') ?></code></td>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="c" style="width:58px">Kode Sekolah</th>
                <th>Sekolah</th>
        ...
        <tr class="<?= $rc ?>">
            ...
            <td class="c" style="font-family:monospace;font-size:9px"><?= e($r['kode_sekolah'] ?? '-') ?></td>
        ...
        <?php endforeach; ?>
        <?php if (!$rows): ?>
        <tr><td colspan="13" style="text-align:center;padding:20px;color:#94a3b8">Belum ada data ujian</td></tr>
        <?php endif; ?>
        </tbody>
    </table>
    <?php endif; ?>
