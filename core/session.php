...
if (session_status() === PHP_SESSION_NONE) {
    ...
    // FIX: Pastikan folder session ada dan bisa ditulis di PC manapun
    // Jangan andalkan session.save_path dari php.ini yang mungkin berbeda tiap PC
...
// ── Cek Lisensi ──────────────────────────────────────────────
if (!defined('BASE_URL')) require_once __DIR__ . '/../config/database.php';
require_once __DIR__ . '/lisensi.php';
lisensiGuard();
