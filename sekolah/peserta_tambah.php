...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $data['kode_sekolah'] = trim($_POST['kode_sekolah'] ?? '');
    ...
    if (!$errors) {
        ...
        $st->bind_param('ssiss', $data['nama'], $data['kelas'], $sekolahId, $data['kode_sekolah'], $kode);
        $st->execute(); $st->close();
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="kode_sekolah" class="form-control"
                                   value="<?= htmlspecialchars($data['kode_sekolah'] ?? '') ?>" placeholder="(opsional)">
                        </div>
                        <div class="col-12">
