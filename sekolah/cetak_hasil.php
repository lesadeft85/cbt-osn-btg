  ...
  <table>
    <thead>
      <tr>
        ...
        <th style="width:80px">Kode Sekolah</th>
    ...
    <tbody>
      <?php if (empty($ledgerData)): ?>
        <tr><td colspan="<?= 6 + count($mapelList) ?>" class="tc muted py-4">Belum ada data nilai.</td></tr>
      ...
      <tr>
        ...
        <td class="tc cn"><?= e($p['kode_sekolah'] ?? '-') ?></td>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th style="width:76px">Kode Sekolah</th>
        <th style="width:40px">Kelas</th>
    ...
    <tbody>
<?php if (empty($rows)): ?>
  <tr><td colspan="15" style="text-align:center;padding:18px;color:#888">Belum ada data hasil ujian.</td></tr>
<?php else:
  $kkmLine = false;
  foreach ($rows as $i => $h):
    $no        = $i + 1;
...
?>
      <tr class="kkm-sep">
        <td colspan="15">&#9660; &nbsp;Di bawah KKM <?= $kkm ?> &mdash; <?= $tLulus ?> peserta tidak lulus</td>
      </tr>
<?php   endif; ?>
      <tr class="<?= $rowCls ?>">
        <td class="tc muted"><?= $no ?></td>
        ...
        <td class="tc cn"><?= e($h['kode_sekolah'] ?? '-') ?></td>
...
<?php endforeach; endif; ?>
    ...
    <tfoot>
      <tr>
        <td colspan="7" class="tl">Jumlah: <?= $total ?> peserta &nbsp;|&nbsp; Lulus: <?= $lulus ?> &nbsp;|&nbsp; Tidak Lulus: <?= $tLulus ?> &nbsp;|&nbsp; % Lulus: <?= $pctLulus ?>%</td>
        <td><?= $avgBenar ?></td>
        <td><?= $avgSalah ?></td>
        <td>&mdash;</td>
        <td>&mdash;</td>
        <td><?= $rata ?></td>
        <td colspan="2" class="tl">Rata-rata: <?= $rata ?></td>
      </tr>
    </tfoot>
  </table>
  <?php endif; ?>
  ...
  <div class="ttd-area">
    <div class="ttd-box">
      ...
      <div class="ttd-j">Mengetahui, Ketua Panitia</div>
    </div>
    <div class="ttd-box">
